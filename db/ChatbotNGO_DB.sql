...
INSERT INTO `ActivityEvent` (`Activity_EventID`, `ProjectID`, `Type`, `Title`, `NGO_ID`, `CreatorUserID`, `Description`, `Status`, `Location`, `ActionPlainID`) VALUES (61, 53, 'Outsource', 'Persistent tangible moderator', 6, 108, 'Alice, very much at first, perhaps,\' said the Mock Turtle replied; \'and then the different branches of Arithmetic--Ambition, Distraction, Uglification, and Derision.\' \'I never heard it say to.', 'Completed', '1494 Emmanuelle Orchard\nLake Norbertburgh, MD 58122', 18);
INSERT INTO `ActivityEvent` (`Activity_EventID`, `ProjectID`, `Type`, `Title`, `NGO_ID`, `CreatorUserID`, `Description`, `Status`, `Location`, `ActionPlainID`) VALUES (62, 43, 'In house', 'Front-line tertiary core', 43, 67, 'Majesty,\' said Two, in a few minutes that she began looking at the great hall, with the glass table as before, \'and things are worse than ever,\' thought the poor little thing howled so, that he.', 'Completed', '008 Lucienne Via\nWest Laury, MD 12393-5645', 12);
INSERT INTO `ActivityEvent` (`Activity_EventID`, `ProjectID`, `Type`, `Title`, `NGO_ID`, `CreatorUserID`, `Description`, `Status`, `Location`, `ActionPlainID`) VALUES (63, 55, 'Outsource', 'Cloned background analyzer', 6, 47, 'After a minute or two, looking for eggs, I know I have done that, you know,\' said Alice very meekly: \'I\'m growing.\' \'You\'ve no right to think,\' said Alice very meekly: \'I\'m growing.\' \'You\'ve no.', 'In progres', '57167 Willie Drive Suite 919\nSouth Cali, MN 96083', 25);
...
INSERT INTO `ActivityEvent` (`Activity_EventID`, `ProjectID`, `Type`, `Title`, `NGO_ID`, `CreatorUserID`, `Description`, `Status`, `Location`, `ActionPlainID`) VALUES (65, 47, 'In house', 'Assimilated methodical firmware', 28, 119, 'King put on her toes when they liked, so that it would be as well as she said to Alice. \'Nothing,\' said Alice. \'Nothing WHATEVER?\' persisted the King. \'When did you call him Tortoise, if he were.', 'Pending', '63643 Birdie Glen\nWest Angelinaberg, NJ 21135-5028', 39);
INSERT INTO `ActivityEvent` (`Activity_EventID`, `ProjectID`, `Type`, `Title`, `NGO_ID`, `CreatorUserID`, `Description`, `Status`, `Location`, `ActionPlainID`) VALUES (66, 33, 'Contract', 'Innovative contextually-based emulation', 28, 165, 'YOU, and no more to do it! Oh dear! I\'d nearly forgotten to ask.\' \'It turned into a butterfly, I should be free of them can explain it,\' said the King; and the other bit. Her chin was pressed so.', 'Pending', '18640 Schiller Ports\nPort Agustinachester, HI 56898', 41);
INSERT INTO `ActivityEvent` (`Activity_EventID`, `ProjectID`, `Type`, `Title`, `NGO_ID`, `CreatorUserID`, `Description`, `Status`, `Location`, `ActionPlainID`) VALUES (67, 32, 'Contract', 'Ergonomic system-worthy knowledgeuser', 49, 67, 'Alice, she went on again: \'Twenty-four hours, I THINK; or is it directed to?\' said one of the miserable Mock Turtle. \'She can\'t explain MYSELF, I\'m afraid, but you might like to drop the jar for.', 'In progres', '054 Conroy Knolls\nCliffordtown, LA 71034', 57);
...
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (101, 'Exclusive directional utilisation', '0', '31', 100);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (102, 'Stand-alone 6thgeneration localareanetwork', '950', '2924385', 156);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (103, 'Cloned empowering knowledgebase', '0', '4', 71);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (105, 'Organized 6thgeneration collaboration', '1116593', '8', 48);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (109, 'Synchronised fault-tolerant architecture', '247728291', '26', 116);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (110, 'Progressive responsive info-mediaries', '19', '4', 124);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (111, 'Sharable 24hour hierarchy', '17923', '0', 131);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (114, 'Optional scalable paradigm', '29612', '129335159', 113);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (116, 'Visionary logistical instructionset', '217379012', '2', 49);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (117, 'Fully-configurable encompassing analyzer', '267974', '367697601', 94);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (120, 'Self-enabling impactful data-warehouse', '6', '251', 51);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (126, 'Phased needs-based localareanetwork', '3650818', '78', 159);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (127, 'Public-key 3rdgeneration hardware', '1321299', '2121448', 126);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (132, 'Decentralized high-level benchmark', '28869', '74237', 114);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (134, 'Organized maximized analyzer', '2239', '1213', 123);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (139, 'Synchronised needs-based application', '0', '0', 18);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (149, 'Inverse 5thgeneration service-desk', '6', '11607515', 51);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (152, 'Automated homogeneous data-warehouse', '179798', '32479', 60);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (154, 'Fully-configurable mission-critical product', '11', '0', 120);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (155, 'Self-enabling analyzing initiative', '3328264', '66', 106);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (161, 'Multi-lateral web-enabled internetsolution', '8', '434416', 137);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (162, 'Grass-roots context-sensitive policy', '0', '24178954', 93);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (163, 'Quality-focused neutral synergy', '100', '76', 65);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (167, 'Operative non-volatile core', '0', '298694', 139);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (170, 'Cross-platform demand-driven solution', '0', '598692', 156);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (176, 'Function-based scalable analyzer', '16', '302578167', 54);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (179, 'Optimized demand-driven product', '1', '502162', 67);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (182, 'Innovative intangible contingency', '2', '16', 131);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (183, 'Open-architected user-facing methodology', '0', '4029215', 113);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (184, 'Decentralized foreground opensystem', '55753', '2', 9);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (186, 'Proactive 24hour solution', '2921', '12049', 48);
INSERT INTO `Projects` (`ProjectID`, `Title`, `AmountRaised`, `AmountNeeded`, `ProjectManagerID`) VALUES (188, 'Switchable maximized internetsolution', '14942', '1392', 19);
...
INSERT INTO `StaffRole` (`RoleID`, `Title`, `Description`) VALUES (1, 'engage 24/7 models', 'March Hare interrupted, yawning. \'I\'m getting tired of swimming about here, O Mouse!\' (Alice thought this a very small cake, on which the wretched Hatter trembled so, that Alice had learnt several.');
INSERT INTO `StaffRole` (`RoleID`, `Title`, `Description`) VALUES (2, 'streamline transparent e-markets', 'Queen shrieked out. \'Behead that Dormouse! Turn that Dormouse out of the wood--(she considered him to you, Though they were all locked; and when she heard one of the Lobster Quadrille, that she did.');
INSERT INTO `StaffRole` (`RoleID`, `Title`, `Description`) VALUES (3, 'expedite back-end portals', 'HIS time of life. The King\'s argument was, that you weren\'t to talk nonsense. The Queen\'s argument was, that you weren\'t to talk nonsense. The Queen\'s Croquet-Ground A large rose-tree stood near the.');
INSERT INTO `StaffRole` (`RoleID`, `Title`, `Description`) VALUES (4, 'enhance cross-platform partnerships', 'The Hatter\'s remark seemed to rise like a telescope.\' And so it was certainly English. \'I don\'t think they play at all what had become of you? I gave her answer. \'They\'re done with a knife, it.');
INSERT INTO `StaffRole` (`RoleID`, `Title`, `Description`) VALUES (5, 'generate frictionless models', 'SAID was, \'Why is a raven like a candle. I wonder if I shall ever see you again, you dear old thing!\' said the Hatter, \'when the Queen merely remarking as it went, as if she were saying lessons, and.');
INSERT INTO `StaffRole` (`RoleID`, `Title`, `Description`) VALUES (6, 'generate frictionless infomediaries', 'Mock Turtle repeated thoughtfully. \'I should have croqueted the Queen\'s ears--\' the Rabbit asked. \'No, I didn\'t,\' said Alice: \'she\'s so extremely--\' Just then her head was so long since she had hurt.');
INSERT INTO `StaffRole` (`RoleID`, `Title`, `Description`) VALUES (7, 'integrate customized schemas', 'SAID was, \'Why is a long way back, and see what I should say \"With what porpoise?\"\' \'Don\'t you mean \"purpose\"?\' said Alice. \'Why not?\' said the Mock Turtle yet?\' \'No,\' said the Queen ordering off.');
